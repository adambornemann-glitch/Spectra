...
open InnerProductSpace MeasureTheory Complex Filter Topology QuantumMechanics.Bochner
...
noncomputable def cayleyTransformOfGroup [CompleteSpace H]
  (U : OneParameterUnitaryGroup (H := H)) : H →L[ℂ] H :=
  cayleyTransform (generator_isFormalAdjoint U)
    ((Stoneslemma.isSelfAdjoint_to_surjective (generator_isSelfAdjoint U)).1)
...
theorem cayleyTransform_surjective_of_isSelfAdjoint [CompleteSpace H]
    ...
    Function.Surjective
      (cayleyTransform (isFormalAdjoint_self_of_isSelfAdjoint hA)
                       (Stoneslemma.isSelfAdjoint_to_surjective hA).1) :=
  cayleyTransform_surjective _ _ (Stoneslemma.isSelfAdjoint_to_surjective hA).2
...
theorem cayleyTransform_unitary_of_isSelfAdjoint [CompleteSpace H]
    ...
    Unitary (cayleyTransform (isFormalAdjoint_self_of_isSelfAdjoint hA)
                             (Stoneslemma.isSelfAdjoint_to_surjective hA).1) :=
  cayleyTransform_unitary _ _ (Stoneslemma.isSelfAdjoint_to_surjective hA).2
...
lemma cayleyTransform_isUnit_of_isSelfAdjoint [CompleteSpace H]
    ...
    IsUnit (cayleyTransform (isFormalAdjoint_self_of_isSelfAdjoint hA)
                            (Stoneslemma.isSelfAdjoint_to_surjective hA).1) :=
  cayleyTransform_isUnit _ _ (Stoneslemma.isSelfAdjoint_to_surjective hA).2
