...
-- Filename: SpectralTheory/Herglotz/Stieltjes/CumulativeDistFun.lean
-/
import Mathlib.MeasureTheory.Measure.Stieltjes
import Mathlib.MeasureTheory.Integral.IntervalIntegral.FundThmCalculus
import Mathlib.MeasureTheory.Integral.DominatedConvergence
import Mathlib.Data.Rat.Defs
-- The following import is to the existing Herglotz file (§1–§3)
...
lemma fejerCDF_monotone (hU : Cayley.Unitary U) (ψ : H) (N : ℕ) :
...
/-- `0 ≤ F_N(x) ≤ ‖ψ‖²` for all `x`. -/
lemma fejerCDF_bounded (hU : Cayley.Unitary U) (ψ : H) (N : ℕ) (x : ℝ) :
...
lemma fejerCDF_eq_measure (hU : Cayley.Unitary U) (ψ : H) (N : ℕ) (a b : ℝ)
