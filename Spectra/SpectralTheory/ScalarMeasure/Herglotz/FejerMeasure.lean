...
Filename: SpectralTheory/Herglotz/FejerMeasure.lean
-/
import Spectra.SpectralTheory.ScalarMeasure.Herglotz.PositiveDefinite
import Spectra.SpectralTheory.ScalarMeasure.Herglotz.UnitaryPowers
import Spectra.SpectralTheory.ScalarMeasure.Herglotz.FejerMeans
...
noncomputable def fejerMeasure (U : H →L[ℂ] H) (_hU : Cayley.Unitary U) (ψ : H) (N : ℕ) : Measure ℝ :=
...
lemma fejerMeanDensity_conj (hU : Cayley.Unitary U) (ψ : H) (N : ℕ) (θ : ℝ) :
...
lemma fejerMeanDensity_ofReal (hU : Cayley.Unitary U) (ψ : H) (N : ℕ) (θ : ℝ) :
...
def fejerDensityNNReal (U : H →L[ℂ] H) (ψ : H) (N : ℕ) (θ : ℝ) : ℝ≥0 :=
...
lemma fejerDensityNNReal_coe (hU : Cayley.Unitary U) (ψ : H) (N : ℕ) (θ : ℝ) :
