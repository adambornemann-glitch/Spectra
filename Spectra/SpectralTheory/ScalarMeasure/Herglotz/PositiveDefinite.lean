...
Filename: Herglotz/PositiveDefinite.lean
-/
...
def unitaryCorrelation (ψ : H) (n : ℤ) : ℂ :=
...
lemma unitaryCorrelation_neg (hU : Cayley.Unitary U) (ψ : H) (n : ℤ) :
...
theorem unitaryCorrelation_positive_definite (hU : Cayley.Unitary U) (ψ : H) (N : ℕ)
    (α : Fin N → ℂ) :
    0 ≤ (∑ j : Fin N, ∑ k : Fin N,
