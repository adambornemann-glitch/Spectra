...
lemma hasFDerivAt_integral_T_density
...
lemma integral_T_smul_fderiv_apply
    {θ₀ : ParamSpace n} (hθ₀ : θ₀ ∈ M.paramDomain)
    (T : Ω → ℝ) (hReg : M.IsRegularEstimator T)
    (i : Fin n) :
    (∫ ω, T ω •
...
lemma integral_T_partialDensity_eq
    {θ₀ : ParamSpace n} (hθ₀ : θ₀ ∈ M.paramDomain)
    (T : Ω → ℝ) (hReg : M.IsRegularEstimator T)
    (i : Fin n) :
...
lemma integral_T_partialDensity_eq_T_score
    {θ₀ : ParamSpace n} (hθ₀ : θ₀ ∈ M.paramDomain)
    (T : Ω → ℝ) (i : Fin n) :
    ∫ ω, T ω * M.partialDensity θ₀ i ω ∂M.refMeasure =
...
lemma estimator_score_integrable
    {θ : ParamSpace n} (hθ : θ ∈ M.paramDomain)
    (T : Ω → ℝ) (hReg : M.IsRegularEstimator T)
...
lemma centered_score_integrable
    {θ : ParamSpace n} (hθ : θ ∈ M.paramDomain)
    (T : Ω → ℝ) (hReg : M.IsRegularEstimator T)
...
lemma centered_estimator_score_integral
    {θ : ParamSpace n} (hθ : θ ∈ M.paramDomain)
    (T : Ω → ℝ)
    (τ : ParamSpace n → ℝ)
    (hReg : M.IsRegularEstimator T)
