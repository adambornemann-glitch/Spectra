...
lemma integrable {θ : ParamSpace n} (hθ : θ ∈ M.paramDomain) :
...
lemma aestronglyMeasurable {θ : ParamSpace n}
    (hθ : θ ∈ M.paramDomain) :
...
lemma logDensity_aemeasurable {θ : ParamSpace n}
    (hθ : θ ∈ M.paramDomain) :
...
lemma exp_logDensity_eq_ae {θ : ParamSpace n}
    (hθ : θ ∈ M.paramDomain) :
...
lemma density_continuousOn (ω : Ω) :
