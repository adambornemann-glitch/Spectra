...
// Module: Spectra.UnitaryEvolution.BochnerIntegration.Limits.Helpers
...
LEAN_EXPORT lean_object* initialize_Spectra_Spectra_UnitaryEvolution_BochnerIntegration_Limits_Helpers(uint8_t builtin) {
lean_object * res;
